...
public class ProductoController implements Initializable {
    ...
    private void modificar(ActionEvent event) {
        ...
        if (p == null) {
            ...
            try {
                ...
                alert.setHeaderText(null);
                alert.setTitle("Error");
                alert.setContentText("Ese producto ya esta");
                alert.showAndWait();
            }
    ...
    private void eliminar(ActionEvent event) {
        ...
        if (p == null) {
            ...
            alert.setHeaderText(null);
            alert.setTitle("Error");
            alert.setContentText("Debes seleccionar un PRODUCTO para comprarlo");
            alert.showAndWait();
        } else {
            ...
            alert.setContentText("Producto Vendido muchas gracias por su compra");
            alert.showAndWait();
